...
class tkinterApp(tk.Tk):
    ...
    def __init__(self):
        ...
        self.icono_chico = tk.PhotoImage(file=os.path.join(basedir, "img", 'icono-16.png'))
        self.icono_grande = tk.PhotoImage(file=os.path.join(basedir, "img", "icono-32.png"))
        self.iconphoto(False, self.icono_chico,self.icono_grande)
...
#---------------Texto--------------------
        ...
        self.texto_resorte=Label(self,text="La impedancia:\n En oscilaciones representa la resistencia al cambio en sistemas eléctricos o mecánicos. \n Al pasar una oscilación de un medio a otro, se producen dos fenómenos clave: la reflexión,\n donde parte de la onda rebota en la interfaz, y la transmisión, donde parte de la \n onda continúa en el nuevo medio. ")
        self.texto_resorte.grid(row=0,column=6,sticky=tk.W)
...
#---------------Texto--------------------
        ...
        self.texto_resorte=Label(self,text="Los osciladores acoplados:\n  Son sistemas con múltiples osciladores que interactúan entre sí, lo que puede llevar a fenómenos sincronizados.\n Los modos normales son patrones específicos de oscilación colectiva que surgen de estas \n interacciones, y son útiles para analizar y comprender el comportamiento \n conjunto de los osciladores acoplados.")
        self.texto_resorte.grid(row=0,column=6,sticky=tk.W)
        self.check(1)
